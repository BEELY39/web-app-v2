...
export default function Component() {
  ...
  return (
    <>
      <div className="mb-4 flex justify-center absolute top-[10px] right-[10px] ">
        <Link href="/" className="px-4 py-2 bg-black text-white rounded-md hover:bg-slate-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
